...
#============================================================
# Rattle timestamp: 2014-12-07 16:04:07 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-07 16:04:25 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-07 16:04:29 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-07 16:04:34 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-07 16:04:36 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-07 16:04:45 x86_64-pc-linux-gnu 
...
# Time taken: 37.90 secs

#============================================================
# Rattle timestamp: 2014-12-07 16:05:26 x86_64-pc-linux-gnu 

# Plot the relative importance of the variables.

varImpPlot(crs$rf, main="")
title(main="Variable Importance Random Forest all-data-Java.csv",
    sub=paste("Rattle", format(Sys.time(), "%Y-%b-%d %H:%M:%S"), Sys.info()["user"]))

#============================================================
# Rattle timestamp: 2014-12-07 16:05:49 x86_64-pc-linux-gnu 
...
library(cairoDevice)
savePlotToFile("/home/kanashiro/Documents/UnB/ML/ML_metrics/analysis/Java/model_random_forest/variable_importance.pdf", 2)

#============================================================
# Rattle timestamp: 2014-12-07 16:06:09 x86_64-pc-linux-gnu 
...
crs$input <- c("R10_cbo", "R10_loc", "R10_sc")

crs$numeric <- c("R10_cbo", "R10_loc", "R10_sc")
...
crs$risk    <- NULL
crs$ident   <- NULL
crs$ignore  <- c("acc", "accm", "amloc", "anpm", "cbo", "dit", "lcom4", "loc", "noa", "noc", "nom", "npa", "npm", "rfc", "sc", "R10_acc", "R10_accm", "R10_amloc", "R10_anpm", "R10_dit", "R10_lcom4", "R10_noa", "R10_noc", "R10_nom", "R10_npa", "R10_npm", "R10_rfc")
crs$weights <- NULL

#============================================================
# Rattle timestamp: 2014-12-07 16:06:14 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-07 16:06:43 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-07 16:07:12 x86_64-pc-linux-gnu 
...
library(cairoDevice)
savePlotToFile("/home/kanashiro/Documents/UnB/ML/ML_metrics/analysis/Java/model_random_forest/decision_tree.pdf", 3)

#============================================================
# Rattle timestamp: 2014-12-07 16:07:17 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-07 16:07:30 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-07 16:07:51 x86_64-pc-linux-gnu 
...
library(cairoDevice)
savePlotToFile("/home/kanashiro/Documents/UnB/ML/ML_metrics/analysis/Java/model_random_forest/ROC.pdf", 3)

#============================================================
# Rattle timestamp: 2014-12-07 16:08:03 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-07 16:08:08 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-07 16:08:49 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-07 16:09:04 x86_64-pc-linux-gnu 
...
library(cairoDevice)
savePlotToFile("/home/kanashiro/Documents/UnB/ML/ML_metrics/analysis/Java/model_random_forest/all_decision_tree.pdf", 3)

#============================================================
# Rattle timestamp: 2014-12-07 16:09:07 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-07 16:09:26 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-07 16:09:49 x86_64-pc-linux-gnu 
...
library(cairoDevice)
savePlotToFile("/home/kanashiro/Documents/UnB/ML/ML_metrics/analysis/Java/model_random_forest/all_ROC.pdf", 3)
