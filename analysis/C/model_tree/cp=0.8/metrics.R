...
#============================================================
# Rattle timestamp: 2014-12-06 20:35:06 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-06 20:35:12 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-06 20:35:15 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-06 20:35:20 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-06 20:35:22 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-06 20:35:37 x86_64-pc-linux-gnu 
...
crs$rpart <- rpart(good_design ~ .,
    ...
    parms=list(split="information"),
      control=rpart.control(cp=0.080000,
        usesurrogate=0, 
        maxsurrogate=0))
...
#============================================================
# Rattle timestamp: 2014-12-06 20:36:00 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-06 20:36:10 x86_64-pc-linux-gnu 
...
library(cairoDevice)
savePlotToFile("/home/kanashiro/Documents/UnB/ML/ML_metrics/analysis/C/model/cp=0.8/decision_tree.pdf", 2)

#============================================================
# Rattle timestamp: 2014-12-06 20:36:15 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-06 20:36:35 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-06 20:36:43 x86_64-pc-linux-gnu 
...
library(cairoDevice)
savePlotToFile("/home/kanashiro/Documents/UnB/ML/ML_metrics/analysis/C/model/cp=0.8/ROC.pdf", 2)
