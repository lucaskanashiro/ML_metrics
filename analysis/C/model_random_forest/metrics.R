...
#============================================================
# Rattle timestamp: 2014-12-07 15:29:38 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-07 15:29:42 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-07 15:29:45 x86_64-pc-linux-gnu 
...
set.seed(crv$seed) 
crs$nobs <- nrow(crs$dataset) # 151123 observations 
crs$sample <- crs$train <- sample(nrow(crs$dataset), 0.7*crs$nobs) # 105786 observations
crs$validate <- sample(setdiff(seq_len(nrow(crs$dataset)), crs$train), 0.15*crs$nobs) # 22668 observations
crs$test <- setdiff(setdiff(seq_len(nrow(crs$dataset)), crs$train), crs$validate) # 22669 observations
...
#============================================================
# Rattle timestamp: 2014-12-07 15:29:49 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-07 15:29:51 x86_64-pc-linux-gnu 
...
crs$input <- c("R10_acc", "R10_accm", "R10_amloc", "R10_anpm",
     "R10_cbo", "R10_lcom4", "R10_loc", "R10_noa",
     "R10_nom", "R10_npa", "R10_npm", "R10_rfc",
     "R10_sc")
...
crs$risk    <- NULL
crs$ident   <- NULL
crs$ignore  <- c("acc", "accm", "amloc", "anpm", "cbo", "lcom4", "loc", "noa", "nom", "npa", "npm", "rfc", "sc")
crs$weights <- NULL

#============================================================
# Rattle timestamp: 2014-12-07 15:29:56 x86_64-pc-linux-gnu 
...
set.seed(crv$seed)
crs$rf <- randomForest(as.factor(good_design) ~ .,
...
# Time taken: 40.57 secs

#============================================================
# Rattle timestamp: 2014-12-07 15:30:42 x86_64-pc-linux-gnu 

# Plot the relative importance of the variables.

varImpPlot(crs$rf, main="")
title(main="Variable Importance Random Forest all-data-C.csv",
    sub=paste("Rattle", format(Sys.time(), "%Y-%b-%d %H:%M:%S"), Sys.info()["user"]))

#============================================================
# Rattle timestamp: 2014-12-07 15:31:41 x86_64-pc-linux-gnu 
...
crs$input <- c("R10_loc", "R10_npm", "R10_rfc")

crs$numeric <- c("R10_loc", "R10_npm", "R10_rfc")
...
crs$risk    <- NULL
crs$ident   <- NULL
crs$ignore  <- c("acc", "accm", "amloc", "anpm", "cbo", "lcom4", "loc", "noa", "nom", "npa", "npm", "rfc", "sc", "R10_acc", "R10_accm", "R10_amloc", "R10_anpm", "R10_cbo", "R10_lcom4", "R10_noa", "R10_nom", "R10_npa", "R10_sc")
crs$weights <- NULL

#============================================================
# Rattle timestamp: 2014-12-07 15:31:46 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-07 15:32:13 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-07 15:32:25 x86_64-pc-linux-gnu 
...
library(cairoDevice)
savePlotToFile("/home/kanashiro/Documents/UnB/ML/ML_metrics/analysis/C/model_random_forest/decision_tree.pdf", 3)

#============================================================
# Rattle timestamp: 2014-12-07 15:32:32 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-07 15:32:57 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-07 15:33:08 x86_64-pc-linux-gnu 
...
library(cairoDevice)
savePlotToFile("/home/kanashiro/Documents/UnB/ML/ML_metrics/analysis/C/model_random_forest/ROC.pdf", 3)

#============================================================
# Rattle timestamp: 2014-12-07 15:33:56 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-07 15:34:09 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-07 15:34:42 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-07 15:34:53 x86_64-pc-linux-gnu 
...
library(cairoDevice)
savePlotToFile("/home/kanashiro/Documents/UnB/ML/ML_metrics/analysis/C/model_random_forest/all_decision_tree.pdf", 4)

#============================================================
# Rattle timestamp: 2014-12-07 15:34:56 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-07 15:35:15 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-07 15:35:38 x86_64-pc-linux-gnu 

# Save the plot to a file. 

# Save the plot on device 6 to a file.

library(cairoDevice)
savePlotToFile("/home/kanashiro/Documents/UnB/ML/ML_metrics/analysis/C/model_random_forest/all_ROC.pdf", 6)
