...
#============================================================
# Rattle timestamp: 2014-12-06 20:39:26 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-06 20:39:31 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-06 20:39:34 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-06 20:40:11 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-06 20:40:43 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-06 20:41:31 x86_64-pc-linux-gnu 
...
p <- p + xlab("good_design\n\nRattle 2014-Dec-06 20:41:31 kanashiro")
...
p <- p + geom_boxplot(aes(x=good_design, fill=good_design), notch=TRUE)
p <- p + stat_summary(aes(x=good_design), fun.y=mean, geom="point", shape=8)
p <- p + xlab("good_design\n\nRattle 2014-Dec-06 20:41:33 kanashiro")
...
p <- p + geom_boxplot(aes(x=good_design, fill=good_design), notch=TRUE)
p <- p + stat_summary(aes(x=good_design), fun.y=mean, geom="point", shape=8)
p <- p + xlab("good_design\n\nRattle 2014-Dec-06 20:41:35 kanashiro")
p <- p + ggtitle("Distribution of sc (sample)\nby good_design")
p <- p + theme(legend.position="none")
print(p)

#============================================================
# Rattle timestamp: 2014-12-06 20:41:51 x86_64-pc-linux-gnu 
...
library(cairoDevice)
savePlotToFile("/home/kanashiro/Documents/UnB/ML/ML_metrics/analysis/C/explore/distributions/sc.pdf", 4)

#============================================================
# Rattle timestamp: 2014-12-06 20:42:05 x86_64-pc-linux-gnu 
...
library(cairoDevice)
savePlotToFile("/home/kanashiro/Documents/UnB/ML/ML_metrics/analysis/C/explore/distributions/rfc.pdf", 3)

#============================================================
# Rattle timestamp: 2014-12-06 20:42:19 x86_64-pc-linux-gnu 
...
library(cairoDevice)
savePlotToFile("/home/kanashiro/Documents/UnB/ML/ML_metrics/analysis/C/explore/distributions/loc.pdf", 2)
