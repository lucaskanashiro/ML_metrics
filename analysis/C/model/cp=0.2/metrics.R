...
#============================================================
# Rattle timestamp: 2014-12-06 20:23:06 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-06 20:23:17 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-06 20:23:20 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-06 20:23:26 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-06 20:23:28 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-06 20:23:34 x86_64-pc-linux-gnu 
...
crs$rpart <- rpart(good_design ~ .,
    ...
    parms=list(split="information"),
      control=rpart.control(cp=0.020000,
        usesurrogate=0, 
        maxsurrogate=0))
...
#============================================================
# Rattle timestamp: 2014-12-06 20:24:02 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-06 20:24:15 x86_64-pc-linux-gnu 
...
library(cairoDevice)
savePlotToFile("/home/kanashiro/Documents/UnB/ML/ML_metrics/analysis/C/model/cp=0.2/decision_tree.pdf", 2)

#============================================================
# Rattle timestamp: 2014-12-06 20:24:19 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-06 20:24:43 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-06 20:24:55 x86_64-pc-linux-gnu 
...
library(cairoDevice)
savePlotToFile("/home/kanashiro/Documents/UnB/ML/ML_metrics/analysis/C/model/cp=0.2/ROC.pdf", 2)
