...
#============================================================
# Rattle timestamp: 2014-12-06 20:25:22 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-06 20:25:33 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-06 20:25:36 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-06 20:25:41 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-06 20:25:43 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-06 20:25:49 x86_64-pc-linux-gnu 
...
crs$rpart <- rpart(good_design ~ .,
    ...
    parms=list(split="information"),
      control=rpart.control(cp=0.030000,
        usesurrogate=0, 
        maxsurrogate=0))
...
#============================================================
# Rattle timestamp: 2014-12-06 20:26:16 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-06 20:26:30 x86_64-pc-linux-gnu 
...
library(cairoDevice)
savePlotToFile("/home/kanashiro/Documents/UnB/ML/ML_metrics/analysis/C/model/cp=0.3/decision_tree.pdf", 2)

#============================================================
# Rattle timestamp: 2014-12-06 20:26:34 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-06 20:26:55 x86_64-pc-linux-gnu 
...
#============================================================
# Rattle timestamp: 2014-12-06 20:27:04 x86_64-pc-linux-gnu 
...
library(cairoDevice)
savePlotToFile("/home/kanashiro/Documents/UnB/ML/ML_metrics/analysis/C/model/cp=0.3/ROC.pdf", 2)
